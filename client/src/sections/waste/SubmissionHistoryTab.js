// components/waste/SubmissionHistoryTab.jsx - Extracted from your existing code
...
export default function SubmissionHistoryTab() {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case 'completed': return 'eva:checkmark-circle-2-fill';
      case 'processing': return 'eva:loader-outline';
      case 'failed': return 'eva:alert-triangle-fill';
                      ...
                      <Stack direction="row" spacing={1} justifyContent="flex-end">
                        ...
                        {submission.status === 'processing' && (
                          <Box sx={{ width: '100%' }}>
                            ...
                            <LinearProgress color="warning" sx={{ height: 6, borderRadius: 1 }} />
                          </Box>
                        )}
                        <IconButton
                          color="error"
